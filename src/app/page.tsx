...
import { REXFUNDING_FACTORY } from "./constants/contracts";

export default function Home() {
  // Get RexfundingFactory contract
  const contract = getContract({
    client: client,
    chain: baseSepolia,
    address: REXFUNDING_FACTORY,
  });

  // Get all campaigns deployed with RexfundingFactory
